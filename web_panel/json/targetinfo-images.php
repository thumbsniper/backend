...
{
    //TODO: validate permissions to see target infos
    $targetId = $_GET['id'];

    $frontend->showTargetInfoImagesJson($draw, $start, $length, $search, $orderColumn, $orderDirection, $targetId);
}
