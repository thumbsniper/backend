...
if(isset($_GET['id']) && Helpers::isValidMd5($_GET['id']))
{
    //TODO: validate permissions to see referrer infos
    $referrerId = $_GET['id'];
    $frontend->showReferrerInfoDeeplinksJson($draw, $start, $length, $search, $orderColumn, $orderDirection, $referrerId);
}
