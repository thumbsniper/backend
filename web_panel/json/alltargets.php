...
if(isset($_GET['order'][0]['column']))
{
    ...
    {
        case 1:
            $orderColumn = Settings::getMongoKeyTargetAttrUrl();
            break;

        case 2:
            $orderColumn = Settings::getMongoKeyTargetAttrTsAdded();
            break;

        case 3:
            $orderColumn = Settings::getMongoKeyTargetAttrTsLastRequested();
            break;

        case 4:
            $orderColumn = Settings::getMongoKeyTargetAttrCounterUpdated();
            break;

        case 5:
            $orderColumn = Settings::getMongoKeyTargetAttrCounterFailed();
            break;

        case 6:
            $orderColumn = Settings::getMongoKeyTargetAttrNumRequests();
            break;
    }
}
...
$frontend->showAllTargetsJson($draw, $start, $length, $search, $orderColumn, $orderDirection);
