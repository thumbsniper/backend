...
<head>
    ...
    <title>Referrer information - {$site.title}</title>
...
<body>
	...
	{include file='navigation.tpl'}
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Referrer information</h1>
                        {if isset($error)}
					...
					<table class="table">
                                            ...
                                            {if isset($account) && ($account->isAdmin() == true && $account->isActAsAdmin())}
                                                <tr>
                                                        ...
                                                        <td style="vertical-align: middle;">{$referrer->getId()}</td>
                                                </tr>
                                            {/if}
                                                <tr>
                                                        <td style="vertical-align: middle;">URL base</td>
                                                        <td style="vertical-align: middle;">
								                            {$referrer->getUrlBase()} <a href="{$referrer->getUrlBase()}" target="_blank"><i class="fa fa-external-link"></i></a>
							                            </td>
                                                </tr>
                                                {if isset($referrerAccount)}
                                                <tr>
                                                    <td style="vertical-align: middle;">Account</td>
                                                    <td style="vertical-align: middle;"><a href="/pages/accountinfo.php?id={$referrerAccount->getId()}">{$referrerAccount->getName()}</a></td>
                                                </tr>
                                                {/if}
                                            </tbody>
                                        </table>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive" style="overflow-x: unset;">
                                <table id="deeplinks" class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <th>URL</th>
        ...
        $(document).ready(function () {
            ...
            var ajaxDailyRequests = function () {
                $.ajax({
                    type: "GET",
                    dataType: 'json',
                    url: "/json/referrerinfo-dailyrequests.php",
                    data: { id: "{$referrer->getId()}", days: 30 },
            ...
            $('#deeplinks').dataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '/json/referrerinfo-deeplinks.php?id={$referrer->getId()}',
                order: [[ 0, "asc" ]],
                columnDefs: [
                    {
                        targets: "_all"
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            return '<a href="' + row[0] + '" target="_blank"><button type="button" class="btn btn-success btn-xs"><i class="fa fa-link"></i></button></a>';
                        },
                        orderable: false
                    }
                ]
            ...
            $('#targets').dataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '/json/referrerinfo-targets.php?id={$referrer->getId()}',
                order: [[ 2, "asc" ]],
                columnDefs: [
                    {
                        targets: "_all"
