...
<head>
    ...
    <title>All Accounts - {$site.title}</title>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive" style="overflow-x: unset;">
                            <table id="accounts" class="table table-striped table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th style="text-align: right; width: 30px;">ID</th>
                                    <th>first name</th>
                                    <th>last name</th>
                                    <th>E-Mail</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#accounts').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '/json/allaccounts.php',
            order: [[ 0, "asc" ]],
            columnDefs: [
                {
                    targets: 0,
                    render: function (data, type, row) {
                        return '<a href="/pages/accountinfo.php?id=' + row[0] + '">' + row[0] + '</a>';
                    },
                    orderable: true
                },
                {
