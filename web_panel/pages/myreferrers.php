...
//TODO: validate url and action
if(isset($_POST['url']))
{
        //add referrer
        $frontend->showMyReferrersPage("add", $_POST['url']);
}else if(isset($_GET['action']))
{
    if($_GET['action'] == "delete" && isset($_GET['id'])) {
        $frontend->showMyReferrersPage("delete", $_GET['id']);
    }else if($_GET['action'] == "enable" || $_GET['action'] == "disable") {
        $frontend->showMyReferrersPage($_GET['action']);
    }
}else
{
        $frontend->showMyReferrersPage(null, null);
}
