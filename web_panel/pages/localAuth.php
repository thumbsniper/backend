...
if(isset($_POST['username']) && isset($_POST['password']))
{
	...
	if($frontend->isValidUserName($userName) && $frontend->isValidPassword($password))
	{
		$frontend->tryLocalAuth($userName, $password);
	}else {
		Panel::addUserMessage('danger', 'Invalid username or password.');
		$frontend->showIndexPage();
	}
}
